...
<body>
    ...
    <div id="mySidebar" class="sidebar">
        ...
        <ul>
            ...
            <li class="active"><a class="active" href="data_pelanggan.php">Pelanggan</a></li>
    ...
    <h3>Informasi Pelanggan</h3>
        <table class="fontdt">
            ...
            <tbody>
                <?php
                $no = 1;
                if (mysqli_num_rows($get_informasi_pelanggan) > 0) {
                    while ($data = mysqli_fetch_assoc($get_informasi_pelanggan)) {
                        echo "<tr>";
                        echo "<td>".$no++."</td>";
