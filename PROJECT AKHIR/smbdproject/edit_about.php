...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/admin/edit_about.css">
...
<body>
    ...
    <div id="mySidebar" class="sidebar">
        ...
        <ul>
            ...
            <li class="active"><a href="data_about.php">Data About</a></li>
    ...
    <div id="content">
    <form style="margin-top: 50px;" method="POST" action="proses/get_edit_about.php">
						<?php
							error_reporting(0);
							$id = $_GET['id'];
