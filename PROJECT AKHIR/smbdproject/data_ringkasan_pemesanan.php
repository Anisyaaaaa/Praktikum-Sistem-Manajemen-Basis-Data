...
include("proses/get_data_ringkasan_pemesanan.php");
?>
<!DOCTYPE html>
<html>
<head>
    <title>Data Ringkasan Pemesanan</title>
...
<body>
    ...
    <div id="mySidebar" class="sidebar">
        ...
        <ul>
            ...
            <li class="active"><a class="active" href="data_ringkasan_pemesanan.php">Pemesanan</a></li>
    ...
    <h3>Ringkasan Pemesanan</h3>
        <table class="fontdt">
            ...
            <tbody>
                <?php
                $no = 1;
                if (mysqli_num_rows($get_data_ringkasan_pemesanan) > 0) {
                    while ($data = mysqli_fetch_assoc($get_data_ringkasan_pemesanan)) {
                        echo "<tr>";
                        echo "<td>".$no++."</td>";
                        echo "<td>".$data['nama_kereta']."</td>";
                        echo "<td>".$data['kelas']."</td>";
                        echo "<td>".$data['jumlah_pelanggan']."</td>";
